...
})({"4WTtW":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "4772e076b376d068e94d351bcd405641"; // @flow
...
},{}],"4gMg3":[function(require,module,exports) {
//@ts-ignore
...
},{"./Main.elm":"2paIR"}],"2paIR":[function(require,module,exports) {
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$init = _Utils_Tuple2({
        ...
        selectState: $author$project$Select$initState,
    ...
    var $author$project$Select$Down = {
        $: 'Down'
    };
    ...
    var $author$project$Select$calculateNextActiveTarget = F3(function(currentTargetIndex, totalTargetCount, direction) {
        if (direction.$ === 'Up') return !currentTargetIndex ? 0 : _Utils_cmp(totalTargetCount, currentTargetIndex + 1) < 0 ? 0 : currentTargetIndex - 1;
        else return _Utils_eq(currentTargetIndex + 1, totalTargetCount) ? currentTargetIndex : _Utils_cmp(totalTargetCount, currentTargetIndex + 1) < 0 ? 0 : currentTargetIndex + 1;
    });
    ...
    var $author$project$Select$setMenuViewportPosition = F5(function(selectId, menuListViewport, _v0, _v1, menuItemVisibility) {
        ...
        switch(menuItemVisibility.$){
            ...
            case 'Below':
                var menuItemDistanceBelow = menuItemElem.element.y + menuItemElem.element.height - (menuListElem.element.y + menuListElem.element.height);
    ...
    var $author$project$Select$shouldQueryNextTargetElement = F2(function(nextTargetIndex, state_) {
        return !_Utils_eq(nextTargetIndex, state_.activeTargetIndex);
    });
    var $author$project$Select$update = F2(function(msg, _v0) {
        ...
        switch(msg.$){
            ...
            case 'SearchableSelectContainerClicked':
                var id = msg.a.a;
                var inputId = $author$project$SelectInput$inputId(id);
                var _v14 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v14.b.a;
                var cmdWithOpenMenu = _v14.c;
                var _v15 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v15.b.a;
                var cmdWithClosedMenu = _v15.c;
                var _v16 = function() {
                    var _v17 = state_.initialMousedown;
                    switch(_v17.$){
                        case 'MultiItemMousedown':
                            return _Utils_Tuple2(state_, $elm$core$Platform$Cmd$none);
                        case 'InputMousedown':
                ...
                var updatedState = _v16.a;
                var updatedCmds = _v16.b;
            ...
            case 'UnsearchableSelectContainerClicked':
                var id = msg.a.a;
                var _v18 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v18.b.a;
                var cmdWithOpenMenu = _v18.c;
                var _v19 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v19.b.a;
                var cmdWithClosedMenu = _v19.c;
                var _v20 = state_.menuOpen ? _Utils_Tuple2(stateWithClosedMenu, cmdWithClosedMenu) : _Utils_Tuple2(stateWithOpenMenu, cmdWithOpenMenu);
                var updatedState = _v20.a;
                var updatedCmd = _v20.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(updatedState, {
                    controlUiFocused: true
                })), $elm$core$Platform$Cmd$batch(_List_fromArray([
                    updatedCmd,
            ...
            case 'ToggleMenuAtKey':
                var _v21 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v21.b.a;
                var cmdWithOpenMenu = _v21.c;
                var _v22 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v22.b.a;
                var cmdWithClosedMenu = _v22.c;
                var _v23 = state_.menuOpen ? _Utils_Tuple2(stateWithClosedMenu, cmdWithClosedMenu) : _Utils_Tuple2(stateWithOpenMenu, cmdWithOpenMenu);
                var updatedState = _v23.a;
                var updatedCmd = _v23.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(updatedState, {
                    controlUiFocused: true
                })), updatedCmd);
            case 'KeyboardDown':
                ...
                var nextActiveTargetIndex = A3($author$project$Select$calculateNextActiveTarget, state_.activeTargetIndex, totalTargetCount, $author$project$Select$Down);
                var nodeQueryForViewportFocus = A2($author$project$Select$shouldQueryNextTargetElement, nextActiveTargetIndex, state_) ? A2($author$project$Select$queryNodesForViewportFocus, selectId, nextActiveTargetIndex) : $elm$core$Platform$Cmd$none;
                var _v24 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v24.b.a;
                var cmdWithOpenMenu = _v24.c;
                var _v25 = state_.menuOpen ? _Utils_Tuple2(_Utils_update(state_, {
                ...
                var updatedState = _v25.a;
                var updatedCmd = _v25.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(updatedState), updatedCmd);
            case 'KeyboardUp':
                var selectId = msg.a;
                var totalTargetCount = msg.b;
                var nextActiveTargetIndex = A3($author$project$Select$calculateNextActiveTarget, state_.activeTargetIndex, totalTargetCount, $author$project$Select$Up);
                var nodeQueryForViewportFocus = A2($author$project$Select$shouldQueryNextTargetElement, nextActiveTargetIndex, state_) ? A2($author$project$Select$queryNodesForViewportFocus, selectId, nextActiveTargetIndex) : $elm$core$Platform$Cmd$none;
                var _v26 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v26.b.a;
                var cmdWithOpenMenu = _v26.c;
                var _v27 = state_.menuOpen ? _Utils_Tuple2(_Utils_update(state_, {
                    activeTargetIndex: nextActiveTargetIndex,
                    menuNavigation: $author$project$Select$Keyboard
                }), nodeQueryForViewportFocus) : _Utils_Tuple2(_Utils_update(stateWithOpenMenu, {
                    menuNavigation: $author$project$Select$Keyboard
                }), cmdWithOpenMenu);
                var updatedState = _v27.a;
                var updatedCmd = _v27.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(updatedState), updatedCmd);
            case 'OpenMenu':
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    activeTargetIndex: 0,
    ...
    var $author$project$Select$ViewSelectInputData = F6(function(id, maybeInputValue, maybeActiveTarget, totalViewableMenuItems, menuOpen, variant) {
        return {
            id: id,
    ...
    var $author$project$Select$viewMenuItem = function(viewMenuItemData) {
        return _Utils_Tuple2($elm$core$String$fromInt(viewMenuItemData.index), A2($rtfeldman$elm_css$Html$Styled$Lazy$lazy, function(data) {
            ...
            return A2($rtfeldman$elm_css$Html$Styled$div, _Utils_ap(_List_fromArray([
                $dzuk_mutant$elm_html_styled_aria$Html$Styled$Attributes$Aria$role('listitem'),
            ...
            ]), _Utils_ap(resolveMouseLeave, resolveMouseUp)), _List_fromArray([
    ...
    var $author$project$Select$viewMenu = function(viewMenuData) {
        var resolveMouseover = _Utils_eq(viewMenuData.menuNavigation, $author$project$Select$Keyboard) ? _List_fromArray([
        ...
        var menuStyles = $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            ...
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$pct(100)),
            $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
            A3($rtfeldman$elm_css$Css$border3, $rtfeldman$elm_css$Css$px(6), $rtfeldman$elm_css$Css$solid, $rtfeldman$elm_css$Css$transparent),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(4)),
        ...
        var menuListStyles = _List_fromArray([
            $rtfeldman$elm_css$Css$maxHeight($rtfeldman$elm_css$Css$px(215)),
            $rtfeldman$elm_css$Css$overflowY($rtfeldman$elm_css$Css$auto),
            $rtfeldman$elm_css$Css$paddingBottom($rtfeldman$elm_css$Css$px(6)),
            $rtfeldman$elm_css$Css$paddingTop($rtfeldman$elm_css$Css$px(4)),
            $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
        ...
        if (!_v0.b) return viewMenuData.loading ? A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
        ...
        else return A2($rtfeldman$elm_css$Html$Styled$div, A2($elm$core$List$cons, menuStyles, resolveMouseover), _List_fromArray([
            ...
            ]), A2($elm$core$List$indexedMap, A5($author$project$Select$buildMenuItem, viewMenuData.selectId, viewMenuData.variant, viewMenuData.initialMousedown, viewMenuData.activeTargetIndex, viewMenuData.menuNavigation), viewMenuData.viewableMenuItems))
        ]));
    };
    ...
    var $author$project$SelectInput$view = F2(function(_v0, id_) {
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, autoSizeInputContainerStyles, _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$input, _Utils_ap(_List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$id($author$project$SelectInput$inputId(id_)),
                $rtfeldman$elm_css$Html$Styled$Attributes$value(inputValue),
                $rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
                A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'autocomplete', 'new-password')
            ]), _Utils_ap(events, inputStyles)), _List_Nil),
    ...
    var $author$project$Select$viewSelectInput = function(viewSelectInputData) {
        var whenArrowEvents = viewSelectInputData.menuOpen && !viewSelectInputData.totalViewableMenuItems ? _List_Nil : _List_fromArray([
            $author$project$Events$isDownArrow(A2($author$project$Select$KeyboardDown, $author$project$Select$SelectId(viewSelectInputData.id), viewSelectInputData.totalViewableMenuItems)),
            $author$project$Events$isUpArrow(A2($author$project$Select$KeyboardUp, $author$project$Select$SelectId(viewSelectInputData.id), viewSelectInputData.totalViewableMenuItems))
        ]);
        var spaceKeydownDecoder = function(decoders) {
            return A2($author$project$Select$canBeSpaceToggled, viewSelectInputData.menuOpen, viewSelectInputData.maybeInputValue) ? A2($elm$core$List$cons, $author$project$Events$isSpace($author$project$Select$ToggleMenuAtKey($author$project$Select$SelectId(viewSelectInputData.id))), decoders) : decoders;
        };
        var resolveInputWidth = function(selectInputConfig) {
            return A2($author$project$SelectInput$inputSizing, $author$project$SelectInput$Dynamic, selectInputConfig);
        };
        var resolveInputValue = A2($elm$core$Maybe$withDefault, '', viewSelectInputData.maybeInputValue);
        var resolveEnterMsg = function(mi) {
            var _v1 = viewSelectInputData.variant;
            if (_v1.$ === 'Multi') return A2($author$project$Select$EnterSelectMulti, mi.item, $author$project$Select$SelectId(viewSelectInputData.id));
        ...
        return A2($author$project$SelectInput$view, A3($elm$core$Basics$apL, $author$project$SelectInput$preventKeydownOn, _Utils_ap(spaceKeydownDecoder(enterKeydownDecoder), A2($elm$core$List$cons, $author$project$Events$isEscape($author$project$Select$CloseMenu), whenArrowEvents)), resolveInputWidth(A2($author$project$SelectInput$onMousedown, $author$project$Select$InputMousedowned, A2($author$project$SelectInput$currentValue, resolveInputValue, A2($author$project$SelectInput$onFocusMsg, $author$project$Select$InputReceivedFocused($elm$core$Maybe$Just($author$project$Select$SelectId(viewSelectInputData.id))), A2($author$project$SelectInput$onBlurMsg, $author$project$Select$OnInputBlurred($elm$core$Maybe$Just($author$project$Select$SelectId(viewSelectInputData.id))), A2($author$project$SelectInput$onInput, $author$project$Select$InputChanged($author$project$Select$SelectId(viewSelectInputData.id)), $author$project$SelectInput$default))))))), viewSelectInputData.id);
    };
...
},{}]},["4WTtW","4gMg3"], "4gMg3", "parcelRequire2e7a")

//# sourceMappingURL=index.cd405641.js.map
