...
})({"1xDW9":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "ee686ce3ebda6973a127d58fedd9ce35"; // @flow
...
},{}],"4eZwt":[function(require,module,exports) {
//@ts-ignore
var _mainElm = require("./Main.elm");
var _elmSelect = require("@confidenceman02/elm-select");
const app = _mainElm.Elm.Main.init({
    node: document.querySelector("main"),
    flags: null
});

},{"./Main.elm":"6bRgt","@confidenceman02/elm-select":"5xT53"}],"6bRgt":[function(require,module,exports) {
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    function _Debugger_messageToString(value) {
        ...
        if (code === 35 || /* a */ 97 <= code && code <= 122) return '…';
        if ([
            'Array_elm_builtin',
            'Set_elm_builtin',
            'RBNode_elm_builtin',
    ...
    var $author$project$Select$Mouse = {
        $: 'Mouse'
    };
    var $author$project$Select$NothingMousedown = {
        $: 'NothingMousedown'
    };
    var $author$project$Select$State = function(a) {
        return {
            $: 'State',
            a: a
        };
    };
    var $author$project$Select$initState = $author$project$Select$State({
        activeTargetIndex: 0,
        controlUiFocused: false,
        initialMousedown: $author$project$Select$NothingMousedown,
        inputValue: $elm$core$Maybe$Nothing,
        jsOptimize: false,
        menuListScrollTop: 0,
        menuNavigation: $author$project$Select$Mouse,
        menuOpen: false,
        menuViewportFocusNodes: $elm$core$Maybe$Nothing
    });
    var $author$project$Select$jsOptimize = F2(function(pred, _v0) {
        var state_ = _v0.a;
        return $author$project$Select$State(_Utils_update(state_, {
            jsOptimize: pred
        }));
    });
    var $author$project$Main$init = _Utils_Tuple2({
        ...
        selectState: A2($author$project$Select$jsOptimize, true, $author$project$Select$initState),
        ...
        switch(declaration.$){
            ...
            case 'MediaRule':
                ...
                return A2($elm$core$List$all, function(_v3) {
                    var properties1 = _v3.c;
                    return $elm$core$List$isEmpty(properties1);
                ...
                var expandDeclaration = function(declaration) {
                    switch(declaration.$){
                        case 'StyleBlockDeclaration':
                            ...
                            return A2($rtfeldman$elm_css$Css$Preprocess$Resolve$applyStyles, nestedStyles1, newDeclarations);
                        case 'MediaRule':
    ...
    var $author$project$Select$ClearSingleSelectItem = {
        $: 'ClearSingleSelectItem'
    };
    var $author$project$Select$CloseMenu = {
        $: 'CloseMenu'
    };
    var $author$project$Select$ContainerMousedown = {
        $: 'ContainerMousedown'
    };
    var $author$project$Select$DeselectMulti = function(a) {
        return {
            $: 'DeselectMulti',
            a: a
        };
    };
    var $author$project$Select$Internal$Down = {
        $: 'Down'
    };
    var $author$project$Select$InputChange = function(a) {
        return {
            $: 'InputChange',
            a: a
        };
    };
    var $author$project$Select$InputMousedown = {
        $: 'InputMousedown'
    };
    var $author$project$Select$Keyboard = {
        $: 'Keyboard'
    };
    var $author$project$Select$MenuItemMousedown = function(a) {
        return {
            $: 'MenuItemMousedown',
            a: a
        };
    };
    var $author$project$Select$MultiItemMousedown = function(a) {
        return {
            $: 'MultiItemMousedown',
            a: a
        };
    };
    var $author$project$Select$OnInputFocused = function(a) {
        return {
            $: 'OnInputFocused',
            a: a
        };
    };
    var $author$project$Select$OpenMenu = {
        $: 'OpenMenu'
    };
    var $author$project$Select$Select = function(a) {
        return {
            $: 'Select',
            a: a
        };
    };
    var $author$project$Select$SelectId = function(a) {
        return {
            $: 'SelectId',
            a: a
        };
    };
    var $author$project$Select$Internal$Up = {
        $: 'Up'
    };
    ...
    var $author$project$Select$Internal$calculateNextActiveTarget = F3(function(currentTargetIndex, totalTargetCount, direction) {
        if (direction.$ === 'Up') return !currentTargetIndex ? totalTargetCount - 1 : _Utils_cmp(totalTargetCount, currentTargetIndex + 1) < 0 ? 0 : currentTargetIndex - 1;
        else return _Utils_eq(currentTargetIndex + 1, totalTargetCount) ? 0 : _Utils_cmp(totalTargetCount, currentTargetIndex + 1) < 0 ? 0 : currentTargetIndex + 1;
    });
    var $author$project$Select$dummyInputIdPrefix = 'dummy-input-';
    var $author$project$Select$getSelectId = function(_v0) {
        var id_ = _v0.a;
        return id_;
    };
    var $author$project$Select$dummyInputId = function(selectId) {
        return _Utils_ap($author$project$Select$dummyInputIdPrefix, $author$project$Select$getSelectId(selectId));
    };
    var $elm$browser$Browser$Dom$focus = _Browser_call('focus');
    var $author$project$SelectInput$inputId = function(iid) {
        return 'kaizen-select-input-target-' + iid;
    };
    var $author$project$Select$Above = {
        $: 'Above'
    };
    var $author$project$Select$Below = {
        $: 'Below'
    };
    var $author$project$Select$Both = {
        $: 'Both'
    };
    var $author$project$Select$Within = {
        $: 'Within'
    };
    var $author$project$Select$calculateMenuBoundaries = function(_v0) {
        var menuListElem = _v0.a;
        return _Utils_Tuple2(menuListElem.element.y, menuListElem.element.y + menuListElem.element.height);
    };
    var $author$project$Select$isMenuItemWithinBottomBoundary = F2(function(_v0, bottomBoundary) {
        var menuItemElement = _v0.a;
        return _Utils_cmp(menuItemElement.element.y + menuItemElement.element.height, bottomBoundary) < 1;
    });
    var $author$project$Select$isMenuItemWithinTopBoundary = F2(function(_v0, topBoundary) {
        var menuItemElement = _v0.a;
        return _Utils_cmp(topBoundary, menuItemElement.element.y) < 1;
    });
    var $author$project$Select$menuItemOrientationInViewport = F2(function(menuListElem, menuItemElem) {
        var _v0 = $author$project$Select$calculateMenuBoundaries(menuListElem);
        var topBoundary = _v0.a;
        var bottomBoundary = _v0.b;
        var _v1 = _Utils_Tuple2(A2($author$project$Select$isMenuItemWithinTopBoundary, menuItemElem, topBoundary), A2($author$project$Select$isMenuItemWithinBottomBoundary, menuItemElem, bottomBoundary));
        if (_v1.a) {
            if (_v1.b) return $author$project$Select$Within;
            else return $author$project$Select$Below;
        } else {
            if (_v1.b) return $author$project$Select$Above;
            else return $author$project$Select$Both;
        }
    });
    var $author$project$Select$FocusMenuViewport = F2(function(a, b) {
        return {
            $: 'FocusMenuViewport',
            a: a,
            b: b
    ...
    var $author$project$Select$MenuItemElement = function(a) {
        return {
            $: 'MenuItemElement',
            a: a
        };
    };
    var $author$project$Select$MenuListElement = function(a) {
        return {
            $: 'MenuListElement',
            a: a
        };
    ...
    var $author$project$Select$menuItemId = F2(function(selectId, index) {
        return 'select-menu-item-' + ($elm$core$String$fromInt(index) + ('-' + $author$project$Select$getSelectId(selectId)));
    });
    var $author$project$Select$queryActiveTargetElement = F2(function(selectId, index) {
        return $elm$browser$Browser$Dom$getElement(A2($author$project$Select$menuItemId, selectId, index));
    });
    var $author$project$Select$menuListId = function(selectId) {
        return 'select-menu-list-' + $author$project$Select$getSelectId(selectId);
    };
    var $author$project$Select$queryMenuListElement = function(selectId) {
        return $elm$browser$Browser$Dom$getElement($author$project$Select$menuListId(selectId));
    };
    var $author$project$Select$queryNodesForViewportFocus = F2(function(selectId, menuItemIndex) {
        return A2($elm$core$Task$attempt, $author$project$Select$FocusMenuViewport(selectId), A3($elm$core$Task$map2, F2(function(menuListElem, menuItemElem) {
            return _Utils_Tuple2($author$project$Select$MenuListElement(menuListElem), $author$project$Select$MenuItemElement(menuItemElem));
        }), $author$project$Select$queryMenuListElement(selectId), A2($author$project$Select$queryActiveTargetElement, selectId, menuItemIndex)));
    });
    var $author$project$Select$DoNothing = {
        $: 'DoNothing'
    };
    var $author$project$Select$listBoxBorder = 6;
    var $author$project$Select$listBoxPaddingBottom = 6;
    var $author$project$Select$listBoxPaddingTop = 4;
    var $elm$browser$Browser$Dom$setViewportOf = _Browser_setViewportOf;
    var $author$project$Select$setMenuViewportPosition = F5(function(selectId, menuListViewport, _v0, _v1, menuItemVisibility) {
        var menuListElem = _v0.a;
        ...
        switch(menuItemVisibility.$){
            ...
            case 'Above':
                var menuItemDistanceAbove = menuListElem.element.y - menuItemElem.element.y + $author$project$Select$listBoxPaddingTop + $author$project$Select$listBoxBorder;
                return _Utils_Tuple2(A2($elm$core$Task$attempt, function(_v3) {
                    return $author$project$Select$DoNothing;
                }, A3($elm$browser$Browser$Dom$setViewportOf, $author$project$Select$menuListId(selectId), 0, menuListViewport - menuItemDistanceAbove)), menuListViewport - menuItemDistanceAbove);
            case 'Below':
                var menuItemDistanceBelow = menuItemElem.element.y + menuItemElem.element.height + $author$project$Select$listBoxPaddingBottom + $author$project$Select$listBoxBorder - (menuListElem.element.y + menuListElem.element.height);
                return _Utils_Tuple2(A2($elm$core$Task$attempt, function(_v4) {
                    return $author$project$Select$DoNothing;
                }, A3($elm$browser$Browser$Dom$setViewportOf, $author$project$Select$menuListId(selectId), 0, menuListViewport + menuItemDistanceBelow)), menuListViewport + menuItemDistanceBelow);
            default:
                var menuItemDistanceAbove = menuListElem.element.y - menuItemElem.element.y;
                return _Utils_Tuple2(A2($elm$core$Task$attempt, function(_v5) {
                    return $author$project$Select$DoNothing;
                }, A3($elm$browser$Browser$Dom$setViewportOf, $author$project$Select$menuListId(selectId), 0, menuListViewport - menuItemDistanceAbove)), menuListViewport - menuItemDistanceAbove);
        }
    });
    var $author$project$Select$Internal$shouldQueryNextTargetElement = F2(function(nextTargetIndex, activeTargetIndex) {
        return !_Utils_eq(nextTargetIndex, activeTargetIndex);
    });
    var $author$project$Select$update = F2(function(msg, _v0) {
        var state_ = _v0.a;
        switch(msg.$){
            case 'EnterSelect':
                var item = msg.a;
                var _v2 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v2.b.a;
                var cmdWithClosedMenu = _v2.c;
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$Select(item)), $author$project$Select$State(_Utils_update(stateWithClosedMenu, {
                    initialMousedown: $author$project$Select$NothingMousedown,
                    inputValue: $elm$core$Maybe$Nothing
                })), cmdWithClosedMenu);
            case 'EnterSelectMulti':
                var item = msg.a;
                var id = msg.b.a;
                var inputId = $author$project$SelectInput$inputId(id);
                var _v3 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v3.b.a;
                var cmdWithClosedMenu = _v3.c;
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$Select(item)), $author$project$Select$State(_Utils_update(stateWithClosedMenu, {
                    initialMousedown: $author$project$Select$NothingMousedown,
                    inputValue: $elm$core$Maybe$Nothing
                })), $elm$core$Platform$Cmd$batch(_List_fromArray([
                    cmdWithClosedMenu,
                    A2($elm$core$Task$attempt, $author$project$Select$OnInputFocused, $elm$browser$Browser$Dom$focus(inputId))
                ])));
            case 'HoverFocused':
                var i = msg.a;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    activeTargetIndex: i
                })), $elm$core$Platform$Cmd$none);
            case 'InputChanged':
                var inputValue = msg.b;
                var _v4 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v4.b.a;
                var cmdWithOpenMenu = _v4.c;
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$InputChange(inputValue)), $author$project$Select$State(_Utils_update(stateWithOpenMenu, {
                    inputValue: $elm$core$Maybe$Just(inputValue)
                })), cmdWithOpenMenu);
            case 'InputReceivedFocused':
                var maybeSelectId = msg.a;
                if (maybeSelectId.$ === 'Just') return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    controlUiFocused: true
                })), $elm$core$Platform$Cmd$none);
                else return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    controlUiFocused: true
                })), $elm$core$Platform$Cmd$none);
            case 'SelectedItem':
                var item = msg.a;
                var _v6 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
            ...
            case 'SelectedItemMulti':
                ...
                var id = msg.b.a;
                var inputId = $author$project$SelectInput$inputId(id);
                var _v7 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v7.b.a;
                var cmdWithClosedMenu = _v7.c;
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$Select(item)), $author$project$Select$State(_Utils_update(stateWithClosedMenu, {
                    initialMousedown: $author$project$Select$NothingMousedown,
                    inputValue: $elm$core$Maybe$Nothing
                })), $elm$core$Platform$Cmd$batch(_List_fromArray([
            ...
            case 'DeselectedMultiItem':
                ...
                var id = msg.b.a;
                var inputId = $author$project$SelectInput$inputId(id);
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$DeselectMulti(deselectedItem)), $author$project$Select$State(_Utils_update(state_, {
                    initialMousedown: $author$project$Select$NothingMousedown
                })), A2($elm$core$Task$attempt, $author$project$Select$OnInputFocused, $elm$browser$Browser$Dom$focus(inputId)));
            case 'OnInputFocused':
                var focusResult = msg.a;
                if (focusResult.$ === 'Ok') return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    initialMousedown: $author$project$Select$NothingMousedown
                })), $elm$core$Platform$Cmd$none);
                else return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(state_), $elm$core$Platform$Cmd$none);
            case 'FocusMenuViewport':
                if (msg.b.$ === 'Ok') {
                    var selectId = msg.a;
                    var _v9 = msg.b.a;
                    var menuListElem = _v9.a;
                    var menuItemElem = _v9.b;
                    var _v10 = A5($author$project$Select$setMenuViewportPosition, selectId, state_.menuListScrollTop, menuListElem, menuItemElem, A2($author$project$Select$menuItemOrientationInViewport, menuListElem, menuItemElem));
                    var viewportFocusCmd = _v10.a;
                    var newViewportY = _v10.b;
                    return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                        menuListScrollTop: newViewportY,
                        menuViewportFocusNodes: $elm$core$Maybe$Just(_Utils_Tuple2(menuListElem, menuItemElem))
                    })), viewportFocusCmd);
                } else return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    menuViewportFocusNodes: $elm$core$Maybe$Nothing
                })), $elm$core$Platform$Cmd$none);
            case 'DoNothing':
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(state_), $elm$core$Platform$Cmd$none);
            case 'OnInputBlurred':
                var _v11 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v11.b.a;
                var cmdWithClosedMenu = _v11.c;
                var _v12 = function() {
                    var _v13 = state_.initialMousedown;
                    switch(_v13.$){
                        case 'ContainerMousedown':
                            return _Utils_Tuple2(_Utils_update(state_, {
                                inputValue: $elm$core$Maybe$Nothing
                            }), $elm$core$Platform$Cmd$none);
                        case 'MultiItemMousedown':
                            return _Utils_Tuple2(state_, $elm$core$Platform$Cmd$none);
                        default:
                            return _Utils_Tuple2(_Utils_update(stateWithClosedMenu, {
                                controlUiFocused: false,
                                initialMousedown: $author$project$Select$NothingMousedown,
                                inputValue: $elm$core$Maybe$Nothing
                            }), $elm$core$Platform$Cmd$batch(_List_fromArray([
                ...
                var updatedState = _v12.a;
                var updatedCmds = _v12.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(updatedState), updatedCmds);
            case 'MenuItemClickFocus':
                var i = msg.a;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    initialMousedown: $author$project$Select$MenuItemMousedown(i)
                })), $elm$core$Platform$Cmd$none);
            case 'MultiItemFocus':
                var index = msg.a;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    initialMousedown: $author$project$Select$MultiItemMousedown(index)
                })), $elm$core$Platform$Cmd$none);
            case 'InputMousedowned':
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    initialMousedown: $author$project$Select$InputMousedown
                })), $elm$core$Platform$Cmd$none);
            case 'InputEscape':
                var _v14 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v14.b.a;
                var cmdWithClosedMenu = _v14.c;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(stateWithClosedMenu, {
                    inputValue: $elm$core$Maybe$Nothing
                })), cmdWithClosedMenu);
            ...
            case 'SearchableSelectContainerClicked':
                var id = msg.a.a;
                var inputId = $author$project$SelectInput$inputId(id);
                var _v15 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v15.b.a;
                var cmdWithOpenMenu = _v15.c;
                var _v16 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v16.b.a;
                var cmdWithClosedMenu = _v16.c;
                var _v17 = function() {
                    var _v18 = state_.initialMousedown;
                    switch(_v18.$){
                        case 'MultiItemMousedown':
                            return _Utils_Tuple2(state_, $elm$core$Platform$Cmd$none);
                        case 'InputMousedown':
                            return _Utils_Tuple2(_Utils_update(stateWithOpenMenu, {
                                initialMousedown: $author$project$Select$NothingMousedown
                            }), cmdWithOpenMenu);
                        case 'NothingMousedown':
                            return state_.menuOpen ? _Utils_Tuple2(_Utils_update(stateWithClosedMenu, {
                                initialMousedown: $author$project$Select$ContainerMousedown
                            }), cmdWithClosedMenu) : _Utils_Tuple2(_Utils_update(stateWithOpenMenu, {
                                initialMousedown: $author$project$Select$ContainerMousedown
                            }), cmdWithOpenMenu);
                        case 'ContainerMousedown':
                            return state_.menuOpen ? _Utils_Tuple2(_Utils_update(stateWithClosedMenu, {
                        ...
                        default:
                            return state_.menuOpen ? _Utils_Tuple2(stateWithClosedMenu, cmdWithClosedMenu) : _Utils_Tuple2(stateWithOpenMenu, cmdWithOpenMenu);
                    }
                }();
                var updatedState = _v17.a;
                var updatedCmds = _v17.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(updatedState, {
                    controlUiFocused: true
                })), $elm$core$Platform$Cmd$batch(_List_fromArray([
                    updatedCmds,
                    A2($elm$core$Task$attempt, $author$project$Select$OnInputFocused, $elm$browser$Browser$Dom$focus(inputId))
            ...
            case 'UnsearchableSelectContainerClicked':
                var id = msg.a.a;
                var _v19 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v19.b.a;
                var cmdWithOpenMenu = _v19.c;
                var _v20 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v20.b.a;
                var cmdWithClosedMenu = _v20.c;
                var _v21 = state_.menuOpen ? _Utils_Tuple2(stateWithClosedMenu, cmdWithClosedMenu) : _Utils_Tuple2(stateWithOpenMenu, cmdWithOpenMenu);
                var updatedState = _v21.a;
                var updatedCmd = _v21.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(updatedState, {
                    controlUiFocused: true
                })), $elm$core$Platform$Cmd$batch(_List_fromArray([
                    updatedCmd,
                    A2($elm$core$Task$attempt, $author$project$Select$OnInputFocused, $elm$browser$Browser$Dom$focus($author$project$Select$dummyInputId($author$project$Select$SelectId(id))))
                ])));
            case 'ToggleMenuAtKey':
                var _v22 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v22.b.a;
                var cmdWithOpenMenu = _v22.c;
                var _v23 = A2($author$project$Select$update, $author$project$Select$CloseMenu, $author$project$Select$State(state_));
                var stateWithClosedMenu = _v23.b.a;
                var cmdWithClosedMenu = _v23.c;
                var _v24 = state_.menuOpen ? _Utils_Tuple2(stateWithClosedMenu, cmdWithClosedMenu) : _Utils_Tuple2(stateWithOpenMenu, cmdWithOpenMenu);
                var updatedState = _v24.a;
                var updatedCmd = _v24.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(updatedState, {
                    controlUiFocused: true
                })), updatedCmd);
            case 'KeyboardDown':
                var selectId = msg.a;
                var totalTargetCount = msg.b;
                var nextActiveTargetIndex = A3($author$project$Select$Internal$calculateNextActiveTarget, state_.activeTargetIndex, totalTargetCount, $author$project$Select$Internal$Down);
                var nodeQueryForViewportFocus = A2($author$project$Select$Internal$shouldQueryNextTargetElement, nextActiveTargetIndex, state_.activeTargetIndex) ? A2($author$project$Select$queryNodesForViewportFocus, selectId, nextActiveTargetIndex) : $elm$core$Platform$Cmd$none;
                var _v25 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v25.b.a;
                var cmdWithOpenMenu = _v25.c;
                var _v26 = state_.menuOpen ? _Utils_Tuple2(_Utils_update(state_, {
                    activeTargetIndex: nextActiveTargetIndex,
                    menuNavigation: $author$project$Select$Keyboard
                }), nodeQueryForViewportFocus) : _Utils_Tuple2(_Utils_update(stateWithOpenMenu, {
                    menuNavigation: $author$project$Select$Keyboard
                }), cmdWithOpenMenu);
                var updatedState = _v26.a;
                var updatedCmd = _v26.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(updatedState), updatedCmd);
            case 'KeyboardUp':
                var selectId = msg.a;
                var totalTargetCount = msg.b;
                var nextActiveTargetIndex = A3($author$project$Select$Internal$calculateNextActiveTarget, state_.activeTargetIndex, totalTargetCount, $author$project$Select$Internal$Up);
                var nodeQueryForViewportFocus = A2($author$project$Select$Internal$shouldQueryNextTargetElement, nextActiveTargetIndex, state_.activeTargetIndex) ? A2($author$project$Select$queryNodesForViewportFocus, selectId, nextActiveTargetIndex) : $elm$core$Platform$Cmd$none;
                var _v27 = A2($author$project$Select$update, $author$project$Select$OpenMenu, $author$project$Select$State(state_));
                var stateWithOpenMenu = _v27.b.a;
                var cmdWithOpenMenu = _v27.c;
                var _v28 = state_.menuOpen ? _Utils_Tuple2(_Utils_update(state_, {
                    activeTargetIndex: nextActiveTargetIndex,
                    menuNavigation: $author$project$Select$Keyboard
                }), nodeQueryForViewportFocus) : _Utils_Tuple2(_Utils_update(stateWithOpenMenu, {
                    activeTargetIndex: nextActiveTargetIndex,
                ...
                var updatedState = _v28.a;
                var updatedCmd = _v28.b;
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(updatedState), updatedCmd);
            case 'OpenMenu':
                return _Utils_Tuple3($elm$core$Maybe$Nothing, $author$project$Select$State(_Utils_update(state_, {
                    activeTargetIndex: 0,
            ...
            case 'SingleSelectClearButtonMouseDowned':
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$ClearSingleSelectItem), $author$project$Select$State(state_), $elm$core$Platform$Cmd$none);
            default:
                var id = msg.a.a;
                var inputId = $author$project$SelectInput$inputId(id);
                return _Utils_Tuple3($elm$core$Maybe$Just($author$project$Select$ClearSingleSelectItem), $author$project$Select$State(state_), A2($elm$core$Task$attempt, $author$project$Select$OnInputFocused, $elm$browser$Browser$Dom$focus(inputId)));
        }
    });
    var $author$project$Main$update = F2(function(msg, model) {
        var sm = msg.a;
        var _v1 = A2($author$project$Select$update, sm, model.selectState);
        ...
        var updatedSelectedItem = function() {
            if (maybeAction.$ === 'Just' && maybeAction.a.$ === 'Select') {
                ...
                return A2($elm$core$Debug$log, 'Selected', $elm$core$Maybe$Just(i));
            } else return model.selectedItem;
        }();
        return _Utils_Tuple2(_Utils_update(model, {
            selectState: selectState,
            selectedItem: updatedSelectedItem
        }), A2($elm$core$Platform$Cmd$map, $author$project$Main$SelectMsg, cmds));
    });
    ...
    var $author$project$Select$Config = function(a) {
        return {
            $: 'Config',
            a: a
        };
    };
    var $author$project$Select$menuItems = F2(function(items, _v0) {
        var config = _v0.a;
        return $author$project$Select$Config(_Utils_update(config, {
            menuItems: items
        }));
    });
    ...
    var $author$project$Select$placeholder = F2(function(plc, _v0) {
        var config = _v0.a;
        return $author$project$Select$Config(_Utils_update(config, {
            placeholder: plc
        }));
    ...
    var $author$project$Select$selectIdentifier = function(id_) {
        return $author$project$Select$SelectId(id_);
    };
    var $author$project$Select$Single = function(a) {
        return {
            $: 'Single',
            a: a
        };
    };
    var $author$project$Select$defaults = {
        clearable: false,
        disabled: false,
        isLoading: false,
        ...
        placeholder: 'Select...',
        searchable: true,
        state: $author$project$Select$initState,
        variant: $author$project$Select$Single($elm$core$Maybe$Nothing)
    };
    var $author$project$Select$single = function(maybeSelectedItem) {
        return $author$project$Select$Config(_Utils_update($author$project$Select$defaults, {
            variant: $author$project$Select$Single(maybeSelectedItem)
        }));
    };
    var $author$project$Select$state = F2(function(state_, _v0) {
        var config = _v0.a;
        return $author$project$Select$Config(_Utils_update(config, {
            state: state_
        }));
    });
    var $author$project$Select$SearchableSelectContainerClicked = function(a) {
        return {
            $: 'SearchableSelectContainerClicked',
            a: a
        };
    };
    var $author$project$Select$UnsearchableSelectContainerClicked = function(a) {
        return {
            $: 'UnsearchableSelectContainerClicked',
            a: a
        };
    };
    var $author$project$Select$ViewDummyInputData = F4(function(id, maybeTargetItem, totalViewableMenuItems, menuOpen) {
        return {
            id: id,
            maybeTargetItem: maybeTargetItem,
            menuOpen: menuOpen,
            totalViewableMenuItems: totalViewableMenuItems
        };
    });
    var $author$project$Select$ViewMenuData = F7(function(variant, selectId, viewableMenuItems, initialMousedown, activeTargetIndex, menuNavigation, loading) {
        return {
            ...
            selectId: selectId,
            variant: variant,
            viewableMenuItems: viewableMenuItems
        };
    });
    var $author$project$Select$ViewSelectInputData = function(id) {
        return function(maybeInputValue) {
            return function(maybeActiveTarget) {
                        ...
                        return function(menuOpen) {
                            return function(variant) {
                                return function(labelledBy) {
                                    return function(jsOptmized) {
                                        return function(controlUiFocused) {
                                            return {
                                                activeTargetIndex: activeTargetIndex,
                                                controlUiFocused: controlUiFocused,
                                                id: id,
                                                jsOptmized: jsOptmized,
                                                labelledBy: labelledBy,
                                                maybeActiveTarget: maybeActiveTarget,
                                                maybeInputValue: maybeInputValue,
                                                menuOpen: menuOpen,
                                                totalViewableMenuItems: totalViewableMenuItems,
                                                variant: variant
                                            };
    ...
    var $author$project$Select$filterMenuItem = F2(function(maybeQuery, item) {
        if (maybeQuery.$ === 'Nothing') return true;
        else {
            if (maybeQuery.a === '') return true;
            else {
                var query = maybeQuery.a;
                return A2($elm$core$String$contains, $elm$core$String$toLower(query), $elm$core$String$toLower(item.label));
            }
        }
    });
    ...
    var $author$project$Select$filterMultiSelectedItems = F2(function(selectedItems, currentMenuItems) {
        return $elm$core$List$isEmpty(selectedItems) ? currentMenuItems : A2($elm$core$List$filter, function(i) {
            return !A2($elm$core$List$member, i, selectedItems);
        }, currentMenuItems);
    });
    var $author$project$Select$buildMenuItems = F2(function(config, state_) {
        var _v0 = config.variant;
        if (_v0.$ === 'Single') return config.searchable ? A2($elm$core$List$filter, $author$project$Select$filterMenuItem(state_.inputValue), config.menuItems) : config.menuItems;
        else {
            var maybeSelectedMenuItems = _v0.b;
            return config.searchable ? A2($author$project$Select$filterMultiSelectedItems, maybeSelectedMenuItems, A2($elm$core$List$filter, $author$project$Select$filterMenuItem(state_.inputValue), config.menuItems)) : A2($author$project$Select$filterMultiSelectedItems, maybeSelectedMenuItems, config.menuItems);
        }
    });
    var $rtfeldman$elm_css$Css$center = $rtfeldman$elm_css$Css$prop1('center');
    var $author$project$Select$SingleSelectClearButtonKeyDowned = function(a) {
        return {
            $: 'SingleSelectClearButtonKeyDowned',
            a: a
        };
    };
    var $author$project$Select$SingleSelectClearButtonMouseDowned = {
    ...
    var $rtfeldman$elm_css$Css$initial = {
        alignItems: $rtfeldman$elm_css$Css$Structure$Compatible,
        all: $rtfeldman$elm_css$Css$Structure$Compatible,
        backgroundAttachment: $rtfeldman$elm_css$Css$Structure$Compatible,
        backgroundBlendMode: $rtfeldman$elm_css$Css$Structure$Compatible,
        backgroundImage: $rtfeldman$elm_css$Css$Structure$Compatible,
        backgroundOrigin: $rtfeldman$elm_css$Css$Structure$Compatible,
        backgroundRepeat: $rtfeldman$elm_css$Css$Structure$Compatible,
        backgroundRepeatShorthand: $rtfeldman$elm_css$Css$Structure$Compatible,
        ...
        flexWrap: $rtfeldman$elm_css$Css$Structure$Compatible,
        fontFamily: $rtfeldman$elm_css$Css$Structure$Compatible,
        fontSize: $rtfeldman$elm_css$Css$Structure$Compatible,
        fontStyle: $rtfeldman$elm_css$Css$Structure$Compatible,
        fontVariant: $rtfeldman$elm_css$Css$Structure$Compatible,
        fontWeight: $rtfeldman$elm_css$Css$Structure$Compatible,
        intOrAuto: $rtfeldman$elm_css$Css$Structure$Compatible,
        justifyContent: $rtfeldman$elm_css$Css$Structure$Compatible,
        ...
        lengthOrNumber: $rtfeldman$elm_css$Css$Structure$Compatible,
        lengthOrNumberOrAutoOrNoneOrContent: $rtfeldman$elm_css$Css$Structure$Compatible,
        listStylePosition: $rtfeldman$elm_css$Css$Structure$Compatible,
        ...
        touchAction: $rtfeldman$elm_css$Css$Structure$Compatible,
        unitLabel: '',
        units: $rtfeldman$elm_css$Css$Internal$IncompatibleUnits,
        value: 'initial',
        visibility: $rtfeldman$elm_css$Css$Structure$Compatible,
        whiteSpace: $rtfeldman$elm_css$Css$Structure$Compatible
    };
    var $rtfeldman$elm_css$Css$inherit = _Utils_update($rtfeldman$elm_css$Css$initial, {
        value: 'inherit'
    });
    ...
    var $author$project$Select$iconButtonStyles = _List_fromArray([
        $rtfeldman$elm_css$Css$displayFlex,
        $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$transparent),
        $rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$px(0)),
        $rtfeldman$elm_css$Css$borderColor(A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0)),
        $rtfeldman$elm_css$Css$border($rtfeldman$elm_css$Css$px(0)),
        $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$inherit)
    ]);
    var $author$project$Events$Enter = {
        $: 'Enter'
    };
    var $elm$json$Json$Decode$andThen = _Json_andThen;
    var $author$project$Events$Backspace = {
        $: 'Backspace'
    };
    var $author$project$Events$DownArrow = {
        $: 'DownArrow'
    };
    var $author$project$Events$Escape = {
        $: 'Escape'
    };
    var $author$project$Events$Other = {
        $: 'Other'
    };
    var $author$project$Events$Shift = {
        $: 'Shift'
    };
    var $author$project$Events$Space = {
        $: 'Space'
    };
    var $author$project$Events$Tab = {
        $: 'Tab'
    };
    var $author$project$Events$UpArrow = {
        $: 'UpArrow'
    };
    var $author$project$Events$backspace = 8;
    var $author$project$Events$downArrow = 40;
    var $author$project$Events$enter = 13;
    var $author$project$Events$escape = 27;
    var $author$project$Events$shift = 16;
    var $author$project$Events$space = 32;
    var $author$project$Events$tab = 9;
    var $author$project$Events$upArrow = 38;
    var $author$project$Events$keyCodeToKey = function(keyCode) {
        return _Utils_eq(keyCode, $author$project$Events$escape) ? $author$project$Events$Escape : _Utils_eq(keyCode, $author$project$Events$backspace) ? $author$project$Events$Backspace : _Utils_eq(keyCode, $author$project$Events$upArrow) ? $author$project$Events$UpArrow : _Utils_eq(keyCode, $author$project$Events$downArrow) ? $author$project$Events$DownArrow : _Utils_eq(keyCode, $author$project$Events$enter) ? $author$project$Events$Enter : _Utils_eq(keyCode, $author$project$Events$space) ? $author$project$Events$Space : _Utils_eq(keyCode, $author$project$Events$shift) ? $author$project$Events$Shift : _Utils_eq(keyCode, $author$project$Events$tab) ? $author$project$Events$Tab : $author$project$Events$Other;
    };
    var $author$project$Events$decoder = $author$project$Events$keyCodeToKey;
    var $elm$json$Json$Decode$fail = _Json_fail;
    var $author$project$Events$isCode = F3(function(key, msg, code) {
        return _Utils_eq($author$project$Events$decoder(code), key) ? $elm$json$Json$Decode$succeed(msg) : $elm$json$Json$Decode$fail('not the right key');
    });
    var $rtfeldman$elm_css$Html$Styled$Events$keyCode = A2($elm$json$Json$Decode$field, 'keyCode', $elm$json$Json$Decode$int);
    var $author$project$Events$isEnter = function(msg) {
        return A2($elm$json$Json$Decode$andThen, A2($author$project$Events$isCode, $author$project$Events$Enter, msg), $rtfeldman$elm_css$Html$Styled$Events$keyCode);
    };
    var $author$project$Events$isSpace = function(msg) {
        return A2($elm$json$Json$Decode$andThen, A2($author$project$Events$isCode, $author$project$Events$Space, msg), $rtfeldman$elm_css$Html$Styled$Events$keyCode);
    };
    ...
    var $author$project$ClearIcon$svgCommonStyles = _List_fromArray([
        $rtfeldman$elm_css$Svg$Styled$Attributes$height('16'),
        $rtfeldman$elm_css$Svg$Styled$Attributes$viewBox('0 0 20 20')
    ]);
    var $author$project$ClearIcon$view = A2($rtfeldman$elm_css$Svg$Styled$svg, $author$project$ClearIcon$svgCommonStyles, _List_fromArray([
    ...
    var $author$project$Select$clearIndicator = F2(function(config, id) {
        var resolveIconButtonStyles = config.disabled ? _List_fromArray([
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(20))
        ]) : _List_fromArray([
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(20)),
            $rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$pointer)
        ]);
        return A2($rtfeldman$elm_css$Html$Styled$button, _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$Events$custom, 'mousedown', A2($elm$json$Json$Decode$map, function(msg) {
                return {
                    message: msg,
                    preventDefault: true,
                    stopPropagation: true
                };
            }, $elm$json$Json$Decode$succeed($author$project$Select$SingleSelectClearButtonMouseDowned))),
            $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(resolveIconButtonStyles, $author$project$Select$iconButtonStyles)),
            A2($rtfeldman$elm_css$Html$Styled$Events$on, 'keydown', $elm$json$Json$Decode$oneOf(_List_fromArray([
                $author$project$Events$isSpace($author$project$Select$SingleSelectClearButtonKeyDowned(id)),
                $author$project$Events$isEnter($author$project$Select$SingleSelectClearButtonKeyDowned(id))
            ])))
        ]), _List_fromArray([
            $author$project$ClearIcon$view
        ]));
    });
    var $rtfeldman$elm_css$Css$default = {
        cursor: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'default'
    };
    var $rtfeldman$elm_css$Html$Styled$span = $rtfeldman$elm_css$Html$Styled$node('span');
    var $author$project$Select$svgCommonStyles = _List_fromArray([
        $rtfeldman$elm_css$Svg$Styled$Attributes$height('20'),
        $rtfeldman$elm_css$Svg$Styled$Attributes$viewBox('0 0 20 20')
    ]);
    var $author$project$Select$dropdownIndicator = function(config) {
        var resolveIconButtonStyles = config.disabled ? _List_fromArray([
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(20))
        ]) : _List_fromArray([
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(20)),
        ...
        return A2($rtfeldman$elm_css$Html$Styled$span, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(resolveIconButtonStyles)
        ]), _List_fromArray([
            A2($rtfeldman$elm_css$Svg$Styled$svg, $author$project$Select$svgCommonStyles, _List_fromArray([
                A2($rtfeldman$elm_css$Svg$Styled$path, _List_fromArray([
    ...
    var $author$project$Select$indicatorContainerStyles = _List_fromArray([
        $rtfeldman$elm_css$Css$displayFlex,
    ...
    var $author$project$Select$isEmptyInputValue = function(inputValue) {
        return $elm$core$String$isEmpty(A2($elm$core$Maybe$withDefault, '', inputValue));
    };
    ...
    var $rtfeldman$elm_css$VirtualDom$Styled$lazyHelp = F2(function(fn, arg) {
        return $rtfeldman$elm_css$VirtualDom$Styled$toUnstyled(fn(arg));
    });
    var $rtfeldman$elm_css$VirtualDom$Styled$lazy = F2(function(fn, arg) {
        return $rtfeldman$elm_css$VirtualDom$Styled$Unstyled(A3($elm$virtual_dom$VirtualDom$lazy2, $rtfeldman$elm_css$VirtualDom$Styled$lazyHelp, fn, arg));
    });
    ...
    var $rtfeldman$elm_css$Html$Styled$Events$preventDefaultOn = F2(function(event, decoder) {
        return A2($rtfeldman$elm_css$VirtualDom$Styled$on, event, $elm$virtual_dom$VirtualDom$MayPreventDefault(decoder));
    });
    ...
    var $rtfeldman$elm_css$Css$static = {
        position: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'static'
    };
    ...
    var $author$project$Select$EnterSelect = function(a) {
        return {
            $: 'EnterSelect',
            a: a
        };
    };
    var $author$project$Select$InputReceivedFocused = function(a) {
        return {
            $: 'InputReceivedFocused',
            a: a
        };
    };
    var $author$project$Select$KeyboardDown = F2(function(a, b) {
        return {
            $: 'KeyboardDown',
            a: a,
            b: b
    ...
    var $author$project$Select$KeyboardUp = F2(function(a, b) {
        return {
            $: 'KeyboardUp',
            a: a,
            b: b
    ...
    var $author$project$Select$OnInputBlurred = function(a) {
        return {
            $: 'OnInputBlurred',
            a: a
        };
    };
    var $author$project$Select$ToggleMenuAtKey = function(a) {
        return {
            $: 'ToggleMenuAtKey',
            a: a
        };
    ...
    var $author$project$Events$isDownArrow = function(msg) {
        return A2($elm$json$Json$Decode$andThen, A2($author$project$Events$isCode, $author$project$Events$DownArrow, msg), $rtfeldman$elm_css$Html$Styled$Events$keyCode);
    };
    var $author$project$Events$isEscape = function(msg) {
        return A2($elm$json$Json$Decode$andThen, A2($author$project$Events$isCode, $author$project$Events$Escape, msg), $rtfeldman$elm_css$Html$Styled$Events$keyCode);
    };
    var $author$project$Events$isUpArrow = function(msg) {
        return A2($elm$json$Json$Decode$andThen, A2($author$project$Events$isCode, $author$project$Events$UpArrow, msg), $rtfeldman$elm_css$Html$Styled$Events$keyCode);
    };
    var $rtfeldman$elm_css$Html$Styled$Events$onBlur = function(msg) {
        return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'blur', $elm$json$Json$Decode$succeed(msg));
    };
    var $rtfeldman$elm_css$Html$Styled$Events$onFocus = function(msg) {
        return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'focus', $elm$json$Json$Decode$succeed(msg));
    };
    ...
    var $rtfeldman$elm_css$Html$Styled$Attributes$tabindex = function(n) {
        return A2($rtfeldman$elm_css$VirtualDom$Styled$attribute, 'tabIndex', $elm$core$String$fromInt(n));
    };
    var $rtfeldman$elm_css$Html$Styled$Attributes$value = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('value');
    var $author$project$Select$viewDummyInput = function(viewDummyInputData) {
        var whenEnterEvent = function() {
            var _v0 = viewDummyInputData.maybeTargetItem;
            if (_v0.$ === 'Just') {
                var menuitem = _v0.a;
                return _List_fromArray([
                    $author$project$Events$isEnter($author$project$Select$EnterSelect(menuitem.item))
                ]);
            } else return _List_Nil;
        }();
        var whenArrowEvents = viewDummyInputData.menuOpen && !viewDummyInputData.totalViewableMenuItems ? _List_Nil : _List_fromArray([
            $author$project$Events$isDownArrow(A2($author$project$Select$KeyboardDown, $author$project$Select$SelectId(viewDummyInputData.id), viewDummyInputData.totalViewableMenuItems)),
            $author$project$Events$isUpArrow(A2($author$project$Select$KeyboardUp, $author$project$Select$SelectId(viewDummyInputData.id), viewDummyInputData.totalViewableMenuItems))
        ]);
        return A2($rtfeldman$elm_css$Html$Styled$input, _List_fromArray([
            ...
            $rtfeldman$elm_css$Html$Styled$Attributes$id('dummy-input-' + viewDummyInputData.id),
            $rtfeldman$elm_css$Html$Styled$Events$onFocus($author$project$Select$InputReceivedFocused($elm$core$Maybe$Nothing)),
            $rtfeldman$elm_css$Html$Styled$Events$onBlur($author$project$Select$OnInputBlurred($elm$core$Maybe$Nothing)),
            A2($rtfeldman$elm_css$Html$Styled$Events$preventDefaultOn, 'keydown', A2($elm$json$Json$Decode$map, function(msg) {
                return _Utils_Tuple2(msg, true);
            }, $elm$json$Json$Decode$oneOf(_Utils_ap(_List_fromArray([
                $author$project$Events$isSpace($author$project$Select$ToggleMenuAtKey($author$project$Select$SelectId(viewDummyInputData.id))),
                $author$project$Events$isEscape($author$project$Select$CloseMenu),
                $author$project$Events$isDownArrow(A2($author$project$Select$KeyboardDown, $author$project$Select$SelectId(viewDummyInputData.id), viewDummyInputData.totalViewableMenuItems)),
                $author$project$Events$isUpArrow(A2($author$project$Select$KeyboardUp, $author$project$Select$SelectId(viewDummyInputData.id), viewDummyInputData.totalViewableMenuItems))
            ]), _Utils_ap(whenEnterEvent, whenArrowEvents)))))
        ]), _List_Nil);
    };
    var $matken11235$html_styled_extra$Html$Styled$Extra$nothing = $rtfeldman$elm_css$Html$Styled$text('');
    var $matken11235$html_styled_extra$Html$Styled$Extra$viewIf = F2(function(condition, html) {
        return condition ? html : $matken11235$html_styled_extra$Html$Styled$Extra$nothing;
    });
    ...
    var $author$project$DotLoadingIcon$logoAnimationDelay = 0.2;
    var $author$project$DotLoadingIcon$logoAnimationDuration = 1;
    ...
    var $author$project$DotLoadingIcon$svgCommonStyles = _List_fromArray([
    ...
    var $author$project$DotLoadingIcon$view = A2($rtfeldman$elm_css$Svg$Styled$svg, $author$project$DotLoadingIcon$svgCommonStyles, _List_fromArray([
        A2($rtfeldman$elm_css$Svg$Styled$path, _List_fromArray([
            $rtfeldman$elm_css$Svg$Styled$Attributes$css(_List_fromArray([
                ...
                $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
                    ...
                    _Utils_Tuple2(33, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(1))
                    ]))
                ]))),
                $rtfeldman$elm_css$Css$animationDuration($rtfeldman$elm_css$Css$sec($author$project$DotLoadingIcon$logoAnimationDuration)),
                A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite'),
                $rtfeldman$elm_css$Css$animationDelay($rtfeldman$elm_css$Css$sec($author$project$DotLoadingIcon$logoAnimationDelay * 2))
            ])),
        ...
        A2($rtfeldman$elm_css$Svg$Styled$path, _List_fromArray([
            $rtfeldman$elm_css$Svg$Styled$Attributes$css(_List_fromArray([
                ...
                $rtfeldman$elm_css$Css$animationDuration($rtfeldman$elm_css$Css$sec($author$project$DotLoadingIcon$logoAnimationDuration)),
                A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite'),
                $rtfeldman$elm_css$Css$animationDelay($rtfeldman$elm_css$Css$sec($author$project$DotLoadingIcon$logoAnimationDelay))
            ])),
    ...
    var $author$project$Select$viewLoading = $author$project$DotLoadingIcon$view;
    var $author$project$Select$MenuListScrollTop = function(a) {
        return {
            $: 'MenuListScrollTop',
            a: a
        };
    };
    var $author$project$Select$SetMouseMenuNavigation = {
    ...
    var $author$project$Select$ViewMenuItemData = F9(function(index, itemSelected, isClickFocused, menuItemIsTarget, selectId, menuItem, menuNavigation, initialMousedown, variant) {
        return {
            index: index,
            initialMousedown: initialMousedown,
            isClickFocused: isClickFocused,
            itemSelected: itemSelected,
            menuItem: menuItem,
            menuItemIsTarget: menuItemIsTarget,
            menuNavigation: menuNavigation,
            selectId: selectId,
            variant: variant
        };
    });
    var $author$project$Select$isMenuItemClickFocused = F2(function(initialMousedown, i) {
        if (initialMousedown.$ === 'MenuItemMousedown') {
            var _int = initialMousedown.a;
            return _Utils_eq(_int, i);
        } else return false;
    });
    var $author$project$Select$isSelected = F2(function(menuItem, maybeSelectedItem) {
        if (maybeSelectedItem.$ === 'Just') {
            var item = maybeSelectedItem.a;
            return _Utils_eq(item, menuItem);
        } else return false;
    });
    var $author$project$Select$isTarget = F2(function(activeTargetIndex, i) {
        return _Utils_eq(activeTargetIndex, i);
    });
    var $author$project$Select$ClearFocusedItem = {
        $: 'ClearFocusedItem'
    };
    var $author$project$Select$HoverFocused = function(a) {
        return {
            $: 'HoverFocused',
            a: a
        };
    };
    var $author$project$Select$MenuItemClickFocus = function(a) {
        return {
            $: 'MenuItemClickFocus',
            a: a
        };
    };
    var $author$project$Select$SelectedItem = function(a) {
        return {
            $: 'SelectedItem',
            a: a
        };
    };
    var $author$project$Select$SelectedItemMulti = F2(function(a, b) {
        return {
            $: 'SelectedItemMulti',
            a: a,
            b: b
    ...
    var $author$project$Select$viewMenuItem = function(viewMenuItemData) {
        return _Utils_Tuple2($elm$core$String$fromInt(viewMenuItemData.index), A2($rtfeldman$elm_css$Html$Styled$Lazy$lazy, function(data) {
            var withTargetStyles = data.menuItemIsTarget && !data.itemSelected ? _List_fromArray([
                $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex('#0168B3')),
                $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex('#E6F0F7'))
            ]) : _List_Nil;
            ...
            var resolvePosinsetAriaAttrib = _List_fromArray([
                A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-posinset', $elm$core$String$fromInt(data.index + 1))
            ]);
            var resolveMouseUpMsg = function() {
                var _v1 = viewMenuItemData.variant;
                if (_v1.$ === 'Multi') return A2($author$project$Select$SelectedItemMulti, data.menuItem.item, viewMenuItemData.selectId);
                else return $author$project$Select$SelectedItem(data.menuItem.item);
            }();
            var resolveMouseUp = function() {
                var _v0 = data.initialMousedown;
                if (_v0.$ === 'MenuItemMousedown') return _List_fromArray([
                    A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mouseup', $elm$json$Json$Decode$succeed(resolveMouseUpMsg))
                ]);
                else return _List_Nil;
            }();
            var resolveMouseLeave = data.isClickFocused ? _List_fromArray([
                A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mouseleave', $elm$json$Json$Decode$succeed($author$project$Select$ClearFocusedItem))
            ]) : _List_Nil;
            var resolveDataTestId = data.menuItemIsTarget ? _List_fromArray([
                A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-test-id', 'listBoxItemTargetFocus' + $elm$core$String$fromInt(data.index))
            ]) : _List_Nil;
            return A2($rtfeldman$elm_css$Html$Styled$li, _Utils_ap(_List_fromArray([
                ...
                A2($rtfeldman$elm_css$Html$Styled$Events$preventDefaultOn, 'mousedown', A2($elm$json$Json$Decode$map, function(msg) {
                    return _Utils_Tuple2(msg, true);
                }, $elm$json$Json$Decode$succeed($author$project$Select$MenuItemClickFocus(data.index)))),
                A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mouseover', $elm$json$Json$Decode$succeed($author$project$Select$HoverFocused(data.index))),
                $rtfeldman$elm_css$Html$Styled$Attributes$id(A2($author$project$Select$menuItemId, data.selectId, data.index)),
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(_List_fromArray([
                    ...
                    A2($rtfeldman$elm_css$Css$padding2, $rtfeldman$elm_css$Css$px(8), $rtfeldman$elm_css$Css$px(8)),
                    $rtfeldman$elm_css$Css$outline($rtfeldman$elm_css$Css$none),
                    $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex('#000000'))
                ]), _Utils_ap(withTargetStyles, _Utils_ap(withIsClickedStyles, withIsSelectedStyles))))
            ]), _Utils_ap(resolveMouseLeave, _Utils_ap(resolveMouseUp, _Utils_ap(resolveDataTestId, _Utils_ap(resolveSelectedAriaAttribs, resolvePosinsetAriaAttrib))))), _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$text(data.menuItem.label)
            ]));
        }, viewMenuItemData));
    };
    var $author$project$Select$buildMenuItem = F7(function(selectId, variant, initialMousedown, activeTargetIndex, menuNavigation, idx, item) {
        if (variant.$ === 'Single') {
            var maybeSelectedItem = variant.a;
            return $author$project$Select$viewMenuItem(A9($author$project$Select$ViewMenuItemData, idx, A2($author$project$Select$isSelected, item, maybeSelectedItem), A2($author$project$Select$isMenuItemClickFocused, initialMousedown, idx), A2($author$project$Select$isTarget, activeTargetIndex, idx), selectId, item, menuNavigation, initialMousedown, variant));
        } else return $author$project$Select$viewMenuItem(A9($author$project$Select$ViewMenuItemData, idx, false, A2($author$project$Select$isMenuItemClickFocused, initialMousedown, idx), A2($author$project$Select$isTarget, activeTargetIndex, idx), selectId, item, menuNavigation, initialMousedown, variant));
    });
    var $rtfeldman$elm_css$Css$maxHeight = $rtfeldman$elm_css$Css$prop1('max-height');
    var $author$project$Select$menuMarginTop = 8;
    ...
    var $author$project$Select$viewMenu = function(viewMenuData) {
        var resolveAttributes = _Utils_eq(viewMenuData.menuNavigation, $author$project$Select$Keyboard) ? _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-test-id', 'listBox'),
            A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mousemove', $elm$json$Json$Decode$succeed($author$project$Select$SetMouseMenuNavigation))
        ]) : _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-test-id', 'listBox')
        ]);
        var menuStyles = _List_fromArray([
            $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$pct(100)),
            $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex('#FFFFFF')),
            $rtfeldman$elm_css$Css$marginBottom($rtfeldman$elm_css$Css$px(8)),
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$pct(100)),
            $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
            A3($rtfeldman$elm_css$Css$border3, $rtfeldman$elm_css$Css$px($author$project$Select$listBoxBorder), $rtfeldman$elm_css$Css$solid, $rtfeldman$elm_css$Css$transparent),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(4)),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(7)),
            A4($rtfeldman$elm_css$Css$boxShadow4, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$px(12), A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.19)),
            $rtfeldman$elm_css$Css$marginTop($rtfeldman$elm_css$Css$px($author$project$Select$menuMarginTop)),
            $rtfeldman$elm_css$Css$zIndex($rtfeldman$elm_css$Css$int(1))
        ]);
        var menuListStyles = _Utils_ap(_List_fromArray([
            $rtfeldman$elm_css$Css$maxHeight($rtfeldman$elm_css$Css$px(215)),
            $rtfeldman$elm_css$Css$overflowY($rtfeldman$elm_css$Css$auto),
            $rtfeldman$elm_css$Css$paddingBottom($rtfeldman$elm_css$Css$px($author$project$Select$listBoxPaddingBottom)),
            $rtfeldman$elm_css$Css$paddingTop($rtfeldman$elm_css$Css$px($author$project$Select$listBoxPaddingTop)),
            $rtfeldman$elm_css$Css$paddingLeft($rtfeldman$elm_css$Css$px(0)),
            $rtfeldman$elm_css$Css$marginTop($rtfeldman$elm_css$Css$px(0)),
            $rtfeldman$elm_css$Css$marginBottom($rtfeldman$elm_css$Css$px(0)),
            $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative)
        ]), menuStyles);
        var _v0 = viewMenuData.viewableMenuItems;
        if (!_v0.b) return viewMenuData.loading ? A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(menuStyles)
        ]), _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(menuListStyles, _List_fromArray([
                    $rtfeldman$elm_css$Css$textAlign($rtfeldman$elm_css$Css$center),
                    $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0.5))
                ])))
            ]), _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$text('Loading...')
            ]))
        ])) : $rtfeldman$elm_css$Html$Styled$text('');
        else return A3($rtfeldman$elm_css$Html$Styled$Keyed$node, 'ul', _Utils_ap(_List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(menuListStyles),
            $rtfeldman$elm_css$Html$Styled$Attributes$id($author$project$Select$menuListId(viewMenuData.selectId)),
            A2($rtfeldman$elm_css$Html$Styled$Events$on, 'scroll', A2($elm$json$Json$Decode$map, $author$project$Select$MenuListScrollTop, A2($elm$json$Json$Decode$at, _List_fromArray([
                'target',
                'scrollTop'
            ]), $elm$json$Json$Decode$float))),
            ...
            }, $elm$json$Json$Decode$succeed($author$project$Select$DoNothing)))
        ]), resolveAttributes), A2($elm$core$List$indexedMap, A5($author$project$Select$buildMenuItem, viewMenuData.selectId, viewMenuData.variant, viewMenuData.initialMousedown, viewMenuData.activeTargetIndex, viewMenuData.menuNavigation), viewMenuData.viewableMenuItems));
    };
    var $author$project$Select$DeselectedMultiItem = F2(function(a, b) {
        return {
            $: 'DeselectedMultiItem',
            a: a,
            b: b
    ...
    var $author$project$Select$MultiItemFocus = function(a) {
        return {
            $: 'MultiItemFocus',
            a: a
        };
    };
    var $author$project$Tag$Config = function(a) {
        return {
            $: 'Config',
            a: a
        };
    };
    var $author$project$Tag$backgroundColor = F2(function(c, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            backgroundColor: c
        }));
    });
    var $author$project$Tag$dataTestId = F2(function(testId, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            dataTestId: testId
        }));
    });
    var $author$project$Tag$defaults = {
        ...
        rightMargin: false,
        truncationWidth: $elm$core$Maybe$Nothing
    };
    var $author$project$Tag$default = $author$project$Tag$Config($author$project$Tag$defaults);
    var $author$project$Tag$onDismiss = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            onDismiss: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$Tag$onMousedown = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            onMousedown: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$Tag$onMouseleave = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            onMouseleave: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$Tag$rightMargin = F2(function(pred, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            rightMargin: pred
        }));
    });
    var $author$project$Tag$truncateWidth = F2(function(width, _v0) {
        var config = _v0.a;
        return $author$project$Tag$Config(_Utils_update(config, {
            truncationWidth: $elm$core$Maybe$Just(width)
        }));
    });
    ...
    var $rtfeldman$elm_css$Css$inlineBlock = {
        display: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'inline-block'
    };
    ...
    var $author$project$Tag$viewClear = function(config) {
        var mouseleave = function(onMouseleaveMsg) {
            return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mouseleave', $elm$json$Json$Decode$succeed(onMouseleaveMsg));
        };
        var mousedown = function(onMousedownMsg) {
            return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mousedown', $elm$json$Json$Decode$succeed(onMousedownMsg));
        };
        var dismiss = function(onDismissMsg) {
            return $rtfeldman$elm_css$Html$Styled$Events$onClick(onDismissMsg);
        };
        var events = A2($elm$core$List$filterMap, $elm$core$Basics$identity, _List_fromArray([
        ...
        return A2($rtfeldman$elm_css$Html$Styled$span, A2($elm$core$List$cons, $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
            $rtfeldman$elm_css$Css$displayFlex,
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$pct(100)),
            $rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
            A2($rtfeldman$elm_css$Css$padding2, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$rem(0.375)),
            $rtfeldman$elm_css$Css$marginRight($rtfeldman$elm_css$Css$rem(-0.6625)),
            $rtfeldman$elm_css$Css$marginLeft($rtfeldman$elm_css$Css$rem(-0.225)),
            $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex('#6B6E94')),
            $rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$pointer),
            $rtfeldman$elm_css$Css$hover(_List_fromArray([
                $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex('#4B4D68'))
            ]))
            ...
            A2($rtfeldman$elm_css$Html$Styled$span, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                    ...
                    $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(8)),
                    $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(8)),
                    $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex('#FFFFFF')),
                    $rtfeldman$elm_css$Css$left($rtfeldman$elm_css$Css$px(10)),
                    $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$px(9))
                ]))
            ]), _List_Nil),
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
    ...
    var $rtfeldman$elm_css$Css$ellipsis = {
        textOverflow: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'ellipsis'
    };
    var $rtfeldman$elm_css$Css$maxWidth = $rtfeldman$elm_css$Css$prop1('max-width');
    var $rtfeldman$elm_css$Css$noWrap = {
        flexDirectionOrWrap: $rtfeldman$elm_css$Css$Structure$Compatible,
        flexWrap: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'nowrap',
        whiteSpace: $rtfeldman$elm_css$Css$Structure$Compatible
    ...
    var $author$project$Tag$viewTextContent = F2(function(config, value) {
        var resolveTruncation = function() {
            var _v0 = config.truncationWidth;
            if (_v0.$ === 'Just') {
                var width = _v0.a;
                return _List_fromArray([
                    ...
                    $rtfeldman$elm_css$Css$maxWidth($rtfeldman$elm_css$Css$px(width))
                ]);
            } else return _List_Nil;
        }();
        return A2($rtfeldman$elm_css$Html$Styled$span, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(A2($elm$core$List$cons, $rtfeldman$elm_css$Css$marginTop($rtfeldman$elm_css$Css$px(-1)), resolveTruncation))
        ]), _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$text(value)
        ]));
    });
    var $author$project$Tag$view = F2(function(_v0, value) {
        var config = _v0.a;
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                $rtfeldman$elm_css$Css$fontSize($rtfeldman$elm_css$Css$rem(0.875)),
                $rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$int(400)),
                $rtfeldman$elm_css$Css$marginRight(resolveRightMargin),
                $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex('#35374A')),
                $rtfeldman$elm_css$Css$display($rtfeldman$elm_css$Css$inlineBlock),
                A3($rtfeldman$elm_css$Css$border3, $rtfeldman$elm_css$Css$px(2), $rtfeldman$elm_css$Css$solid, $rtfeldman$elm_css$Css$transparent),
                $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(16)),
                A2($rtfeldman$elm_css$Css$padding2, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$px(9.6)),
                $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
                $rtfeldman$elm_css$Css$backgroundColor(config.backgroundColor),
                $rtfeldman$elm_css$Css$hover(_List_fromArray([
                    $rtfeldman$elm_css$Css$borderColor($rtfeldman$elm_css$Css$hex('#C4C5D4'))
                ])),
                $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(30))
            ])),
            ...
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                ...
                A2($author$project$Tag$viewTextContent, config, value),
                $author$project$Tag$viewClear(config)
            ]))
        ]));
    });
    var $author$project$Select$viewMultiValue = F5(function(selectId, config, mousedownedItem, index, menuItem) {
        var withTagColor = function(tagConfig) {
            var _v2 = config.multiTagColor;
            if (_v2.$ === 'Just') {
                var c = _v2.a;
                return A2($author$project$Tag$backgroundColor, c, tagConfig);
            } else return tagConfig;
        };
        var resolveVariant = $author$project$Tag$default;
        var resolveTruncationWidth = function(tagConfig) {
            var _v1 = config.tagTruncation;
            if (_v1.$ === 'Just') {
                var width = _v1.a;
                return A2($author$project$Tag$truncateWidth, width, tagConfig);
            } else return tagConfig;
        };
        ...
        var resolveMouseleave = function(tagConfig) {
            return isMousedowned ? A2($author$project$Tag$onMouseleave, $author$project$Select$ClearFocusedItem, tagConfig) : tagConfig;
        };
        return A2($author$project$Tag$view, resolveMouseleave(resolveTruncationWidth(withTagColor(A2($author$project$Tag$dataTestId, 'multiSelectTag' + $elm$core$String$fromInt(index), A2($author$project$Tag$rightMargin, true, A2($author$project$Tag$onMousedown, $author$project$Select$MultiItemFocus(index), A2($author$project$Tag$onDismiss, A2($author$project$Select$DeselectedMultiItem, menuItem.item, selectId), resolveVariant))))))), menuItem.label);
    });
    ...
    var $rtfeldman$elm_css$Css$transform = function(only) {
        return $rtfeldman$elm_css$Css$transforms(_List_fromArray([
            only
        ]));
    };
    var $rtfeldman$elm_css$Css$translateY = function(_v0) {
        ...
        return {
            transform: $rtfeldman$elm_css$Css$Structure$Compatible,
            value: A2($rtfeldman$elm_css$Css$cssFunction, 'translateY', _List_fromArray([
                value
            ]))
        };
    };
    var $author$project$Select$basePlaceholder = _List_fromArray([
        $rtfeldman$elm_css$Css$marginLeft($rtfeldman$elm_css$Css$px(2)),
        $rtfeldman$elm_css$Css$marginRight($rtfeldman$elm_css$Css$px(2)),
        $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$pct(50)),
        $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
        $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
        $rtfeldman$elm_css$Css$transform($rtfeldman$elm_css$Css$translateY($rtfeldman$elm_css$Css$pct(-50)))
    ]);
    var $author$project$Select$placeholderStyles = A2($elm$core$List$cons, $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0.5)), $author$project$Select$basePlaceholder);
    var $author$project$Select$viewPlaceholder = function(config) {
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Select$placeholderStyles)
        ]), _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$text(config.placeholder)
        ]));
    };
    var $author$project$SelectInput$Dynamic = {
        $: 'Dynamic'
    };
    var $author$project$SelectInput$DynamicJsOptimized = function(a) {
        return {
            $: 'DynamicJsOptimized',
            a: a
        };
    };
    var $author$project$Select$EnterSelectMulti = F2(function(a, b) {
        return {
            $: 'EnterSelectMulti',
            a: a,
            b: b
    ...
    var $author$project$Select$InputChanged = F2(function(a, b) {
        return {
            $: 'InputChanged',
            a: a,
            b: b
    ...
    var $author$project$Select$InputEscape = {
        $: 'InputEscape'
    };
    var $author$project$Select$InputMousedowned = {
        $: 'InputMousedowned'
    };
    var $author$project$SelectInput$Config = function(a) {
        return {
            $: 'Config',
            a: a
        };
    };
    var $author$project$SelectInput$activeDescendant = F2(function(s, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            ariaActiveDescendant: $elm$core$Maybe$Just(s)
        }));
    });
    var $author$project$Select$canBeSpaceToggled = F2(function(menuOpen, inputValue) {
        return !menuOpen && $author$project$Select$isEmptyInputValue(inputValue);
    });
    var $author$project$SelectInput$currentValue = F2(function(value_, _v0) {
        var config = _v0.a;
        return $elm$core$String$isEmpty(value_) ? $author$project$SelectInput$Config(_Utils_update(config, {
            currentValue: $elm$core$Maybe$Nothing
        })) : $author$project$SelectInput$Config(_Utils_update(config, {
            currentValue: $elm$core$Maybe$Just(value_)
        }));
    });
    var $author$project$SelectInput$defaultWidth = 2;
    var $author$project$SelectInput$defaults = {
        ...
        disabled: false,
        inputSizing: $author$project$SelectInput$Dynamic,
        minWidth: $author$project$SelectInput$defaultWidth,
        onBlur: $elm$core$Maybe$Nothing,
        onFocus: $elm$core$Maybe$Nothing,
        onInput: $elm$core$Maybe$Nothing,
        onMousedown: $elm$core$Maybe$Nothing,
        preventKeydownOn: _List_Nil
    };
    var $author$project$SelectInput$default = $author$project$SelectInput$Config($author$project$SelectInput$defaults);
    var $author$project$SelectInput$inputSizing = F2(function(width, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            inputSizing: width
        }));
    });
    var $author$project$SelectInput$onBlurMsg = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            onBlur: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$SelectInput$onFocusMsg = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            onFocus: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$SelectInput$onInput = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            onInput: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$SelectInput$onMousedown = F2(function(msg, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            onMousedown: $elm$core$Maybe$Just(msg)
        }));
    });
    var $author$project$SelectInput$preventKeydownOn = F2(function(decoders, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            preventKeydownOn: decoders
        }));
    });
    var $author$project$SelectInput$setAriaControls = F2(function(s, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            ariaControls: $elm$core$Maybe$Just(s)
        }));
    });
    var $author$project$SelectInput$setAriaExpanded = F2(function(expanded, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
            ariaExpanded: expanded
        }));
    });
    var $author$project$SelectInput$setAriaLabelledBy = F2(function(s, _v0) {
        var config = _v0.a;
        return $author$project$SelectInput$Config(_Utils_update(config, {
    ...
    var $author$project$Events$stringAt = function(path) {
        return A2($elm$json$Json$Decode$at, path, $elm$json$Json$Decode$string);
    };
    var $author$project$Events$mapAt = F2(function(path, msg) {
        return A2($elm$json$Json$Decode$map, msg, $author$project$Events$stringAt(path));
    });
    var $author$project$Events$onInputAt = F2(function(path, msg) {
        return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'input', A2($author$project$Events$mapAt, path, msg));
    });
    var $rtfeldman$elm_css$Html$Styled$Attributes$size = function(n) {
        return A2($rtfeldman$elm_css$VirtualDom$Styled$attribute, 'size', $elm$core$String$fromInt(n));
    };
    var $author$project$SelectInput$sizerId = function(sid) {
        return 'kaizen-select-input-sizer-target-' + sid;
    };
    var $rtfeldman$elm_css$Html$Styled$Attributes$type_ = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('type');
    var $author$project$SelectInput$view = F2(function(_v0, id_) {
        var config = _v0.a;
        var withAriaOwns = function() {
            var _v5 = config.ariaControls;
            if (_v5.$ === 'Just') {
                var al = _v5.a;
                return _List_fromArray([
        ...
        var withAriaActiveDescendant = function() {
            var _v2 = config.ariaActiveDescendant;
            if (_v2.$ === 'Just') {
                var s = _v2.a;
                return _List_fromArray([
        ...
        var resolveSizerId = $author$project$SelectInput$sizerId(id_);
        var resolveInputId = $author$project$SelectInput$inputId(id_);
        var preventOn = A2($rtfeldman$elm_css$Html$Styled$Events$preventDefaultOn, 'keydown', A2($elm$json$Json$Decode$map, function(m) {
            return _Utils_Tuple2(m, true);
        }, $elm$json$Json$Decode$oneOf(config.preventKeydownOn)));
        var mousedown = function(mousedownMsg) {
            return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mousedown', $elm$json$Json$Decode$succeed(mousedownMsg));
        };
        var input_ = function(changeMsg) {
            return A2($author$project$Events$onInputAt, _List_fromArray([
                'target',
                'value'
            ]), changeMsg);
        };
        ...
        var buildDynamcSelectInputProps = A2($elm$json$Json$Encode$encode, 0, $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('sizerId', $elm$json$Json$Encode$string(resolveSizerId)),
            _Utils_Tuple2('defaultInputWidth', $elm$json$Json$Encode$int($author$project$SelectInput$defaultWidth))
        ])));
        var inputWidthStyle = function() {
            var _v1 = config.inputSizing;
            if (_v1.$ === 'Dynamic') return $elm$core$String$isEmpty(inputValue) ? _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$size(1)
            ]) : _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$size($elm$core$String$length(inputValue) + config.minWidth)
            ]);
            else {
                if (_v1.a) return _List_fromArray([
                    A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'width', $elm$core$String$fromInt(config.minWidth) + 'px'),
                    A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-es-dynamic-select-input', buildDynamcSelectInputProps)
                ]);
                else return _List_fromArray([
                    A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'width', $elm$core$String$fromInt(config.minWidth) + 'px')
                ]);
        ...
        var inputStyles = _Utils_ap(_List_fromArray([
        ...
        var events = config.disabled ? _List_Nil : _Utils_ap(A2($elm$core$List$filterMap, $elm$core$Basics$identity, _List_fromArray([
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _Utils_ap(autoSizeInputContainerStyles, _Utils_ap(withAriaOwns, withAriaExpanded)), _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$input, _Utils_ap(_List_fromArray([
                ...
                A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-test-id', config.dataTestId)
            ]), _Utils_ap(events, _Utils_ap(inputStyles, _Utils_ap(withAriaActiveDescendant, _Utils_ap(withAriaControls, withAriaLabelledBy))))), _List_Nil),
            A2($rtfeldman$elm_css$Html$Styled$div, A2($elm$core$List$cons, $rtfeldman$elm_css$Html$Styled$Attributes$id($author$project$SelectInput$sizerId(id_)), sizerStyles), _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$text(inputValue)
            ]))
        ]));
    });
    var $author$project$Select$viewSelectInput = function(viewSelectInputData) {
        var selectId = $author$project$Select$getSelectId(viewSelectInputData.id);
        var spaceKeydownDecoder = function(decoders) {
            return A2($author$project$Select$canBeSpaceToggled, viewSelectInputData.menuOpen, viewSelectInputData.maybeInputValue) ? A2($elm$core$List$cons, $author$project$Events$isSpace($author$project$Select$ToggleMenuAtKey($author$project$Select$SelectId(selectId))), decoders) : decoders;
        };
        var whenArrowEvents = viewSelectInputData.menuOpen && !viewSelectInputData.totalViewableMenuItems ? _List_Nil : _List_fromArray([
            $author$project$Events$isDownArrow(A2($author$project$Select$KeyboardDown, $author$project$Select$SelectId(selectId), viewSelectInputData.totalViewableMenuItems)),
            $author$project$Events$isUpArrow(A2($author$project$Select$KeyboardUp, $author$project$Select$SelectId(selectId), viewSelectInputData.totalViewableMenuItems))
        ]);
        var resolveInputWidth = function(selectInputConfig) {
            return viewSelectInputData.jsOptmized ? A2($author$project$SelectInput$inputSizing, $author$project$SelectInput$DynamicJsOptimized(viewSelectInputData.controlUiFocused), selectInputConfig) : A2($author$project$SelectInput$inputSizing, $author$project$SelectInput$Dynamic, selectInputConfig);
        };
        var resolveInputValue = A2($elm$core$Maybe$withDefault, '', viewSelectInputData.maybeInputValue);
        var resolveEnterMsg = function(mi) {
            var _v3 = viewSelectInputData.variant;
            if (_v3.$ === 'Multi') return A2($author$project$Select$EnterSelectMulti, mi.item, $author$project$Select$SelectId(selectId));
            else return $author$project$Select$EnterSelect(mi.item);
        };
        var resolveAriaLabelledBy = function(config) {
            var _v2 = viewSelectInputData.labelledBy;
            if (_v2.$ === 'Just') {
                var s = _v2.a;
                return A2($author$project$SelectInput$setAriaLabelledBy, s, config);
            } else return config;
        };
        var resolveAriaExpanded = function(config) {
            return A2($author$project$SelectInput$setAriaExpanded, viewSelectInputData.menuOpen, config);
        };
        var resolveAriaControls = function(config) {
            return A2($author$project$SelectInput$setAriaControls, $author$project$Select$menuListId(viewSelectInputData.id), config);
        };
        var resolveAriaActiveDescendant = function(config) {
            var _v1 = viewSelectInputData.maybeActiveTarget;
            if (_v1.$ === 'Just') return A2($author$project$SelectInput$activeDescendant, A2($author$project$Select$menuItemId, viewSelectInputData.id, viewSelectInputData.activeTargetIndex), config);
            else return config;
        };
        var enterKeydownDecoder = function() {
            var _v0 = viewSelectInputData.maybeActiveTarget;
            if (_v0.$ === 'Just') {
                var mi = _v0.a;
                return _List_fromArray([
                    $author$project$Events$isEnter(resolveEnterMsg(mi))
                ]);
            } else return _List_Nil;
        }();
        return A2($author$project$SelectInput$view, A3($elm$core$Basics$apL, $author$project$SelectInput$preventKeydownOn, _Utils_ap(spaceKeydownDecoder(enterKeydownDecoder), A2($elm$core$List$cons, $author$project$Events$isEscape($author$project$Select$InputEscape), whenArrowEvents)), resolveAriaExpanded(resolveAriaLabelledBy(resolveAriaControls(resolveAriaActiveDescendant(resolveInputWidth(A2($author$project$SelectInput$onMousedown, $author$project$Select$InputMousedowned, A2($author$project$SelectInput$currentValue, resolveInputValue, A2($author$project$SelectInput$onFocusMsg, $author$project$Select$InputReceivedFocused($elm$core$Maybe$Just($author$project$Select$SelectId(selectId))), A2($author$project$SelectInput$onBlurMsg, $author$project$Select$OnInputBlurred($elm$core$Maybe$Just($author$project$Select$SelectId(selectId))), A2($author$project$SelectInput$onInput, $author$project$Select$InputChanged($author$project$Select$SelectId(selectId)), $author$project$SelectInput$default))))))))))), selectId);
    };
    var $author$project$Select$bold = _List_fromArray([
        $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex('#35374A')),
        $rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$int(400))
    ]);
    var $rtfeldman$elm_css$Css$calcExpressionToString = function(expression) {
        if (expression.$ === 'Addition') return '+';
        else return '-';
    };
    var $rtfeldman$elm_css$Css$calc = F3(function(firstExpr, expression, secondExpr) {
        ...
        var calcs = A2($elm$core$String$join, ' ', _List_fromArray([
            withoutCalcStr(firstExpr),
            $rtfeldman$elm_css$Css$calcExpressionToString(expression),
            withoutCalcStr(secondExpr)
        ]));
        var value = A2($rtfeldman$elm_css$Css$cssFunction, 'calc', _List_fromArray([
            calcs
        ]));
        return {
            calc: $rtfeldman$elm_css$Css$Structure$Compatible,
    ...
    var $rtfeldman$elm_css$Css$Subtraction = {
        $: 'Subtraction'
    };
    var $rtfeldman$elm_css$Css$minus = $rtfeldman$elm_css$Css$Subtraction;
    var $author$project$Select$viewSelectedPlaceholder = function(item) {
        var addedStyles = _List_fromArray([
            $rtfeldman$elm_css$Css$maxWidth(A3($rtfeldman$elm_css$Css$calc, $rtfeldman$elm_css$Css$pct(100), $rtfeldman$elm_css$Css$minus, $rtfeldman$elm_css$Css$px(8))),
            $rtfeldman$elm_css$Css$textOverflow($rtfeldman$elm_css$Css$ellipsis),
            $rtfeldman$elm_css$Css$whiteSpace($rtfeldman$elm_css$Css$noWrap),
            $rtfeldman$elm_css$Css$overflow($rtfeldman$elm_css$Css$hidden)
        ]);
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap($author$project$Select$basePlaceholder, _Utils_ap($author$project$Select$bold, addedStyles))),
            A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-test-id', 'selectedItem')
        ]), _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$text(item.label)
        ]));
    };
    var $rtfeldman$elm_css$Css$wrap = {
        flexDirectionOrWrap: $rtfeldman$elm_css$Css$Structure$Compatible,
        flexWrap: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'wrap'
    };
    ...
    var $author$project$Select$view = F2(function(_v0, selectId) {
        var config = _v0.a;
        var resolveContainerMsg = config.searchable ? $author$project$Select$SearchableSelectContainerClicked(selectId) : $author$project$Select$UnsearchableSelectContainerClicked(selectId);
        var _v1 = config.state;
        var state_ = _v1.a;
        var preventDefault = function() {
            if (config.searchable) {
                var _v6 = state_.initialMousedown;
                switch(_v6.$){
                    case 'NothingMousedown':
                        return false;
                    case 'InputMousedown':
        ...
        var viewableMenuItems = A2($author$project$Select$buildMenuItems, config, state_);
        var enterSelectTargetItem = state_.menuOpen && !$elm$core$List$isEmpty(viewableMenuItems) ? A2($elm_community$list_extra$List$Extra$getAt, state_.activeTargetIndex, viewableMenuItems) : $elm$core$Maybe$Nothing;
        var totalMenuItems = $elm$core$List$length(viewableMenuItems);
        return A2($rtfeldman$elm_css$Html$Styled$div, A2($elm$core$List$cons, $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
            $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox)
        ])), config.disabled ? _List_Nil : _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$Events$preventDefaultOn, 'mousedown', A2($elm$json$Json$Decode$map, function(msg) {
                return _Utils_Tuple2(msg, preventDefault);
            }, $elm$json$Json$Decode$succeed(resolveContainerMsg)))
        ])), _List_fromArray([
            function() {
                var controlFocusedStyles = state_.controlUiFocused ? _List_fromArray([
                    $rtfeldman$elm_css$Css$borderColor($rtfeldman$elm_css$Css$hex('#0168b3'))
                ]) : _List_Nil;
                return A2($rtfeldman$elm_css$Html$Styled$div, A2($elm$core$List$cons, $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(_List_fromArray([
                    $rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
                    $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex('#FFFFFF')),
                    $rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$default),
                    $rtfeldman$elm_css$Css$displayFlex,
                    ...
                    $rtfeldman$elm_css$Css$minHeight($rtfeldman$elm_css$Css$px(48)),
                    $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
                    $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
                    A3($rtfeldman$elm_css$Css$border3, $rtfeldman$elm_css$Css$px(2), $rtfeldman$elm_css$Css$solid, $rtfeldman$elm_css$Css$hex('#898BA9')),
                    $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(7)),
                    $rtfeldman$elm_css$Css$outline($rtfeldman$elm_css$Css$zero),
                    config.disabled ? $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0.3)) : $rtfeldman$elm_css$Css$hover(_List_fromArray([
                        $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex('#F0F1F4')),
                        $rtfeldman$elm_css$Css$borderColor($rtfeldman$elm_css$Css$hex('#4B4D68'))
                    ]))
                ]), controlFocusedStyles)), config.disabled ? _List_Nil : _List_fromArray([
                    A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-test-id', 'selectContainer')
                ])), _List_fromArray([
                    function() {
                        var withDisabledStyles = config.disabled ? _List_fromArray([
                            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$static)
                        ]) : _List_Nil;
                        var resolvePlaceholder = function() {
                            var _v3 = config.variant;
                            if (_v3.$ === 'Multi') {
                                if (!_v3.b.b) return $author$project$Select$viewPlaceholder(config);
                                else return $rtfeldman$elm_css$Html$Styled$text('');
                            } else if (_v3.a.$ === 'Just') {
                                var v = _v3.a.a;
                                return $author$project$Select$viewSelectedPlaceholder(v);
                            } else {
                                var _v4 = _v3.a;
                                return $author$project$Select$viewPlaceholder(config);
                            }
                        }();
                        var buildPlaceholder = $author$project$Select$isEmptyInputValue(state_.inputValue) ? resolvePlaceholder : $rtfeldman$elm_css$Html$Styled$text('');
                        var buildInput = !config.disabled ? config.searchable ? A2($rtfeldman$elm_css$Html$Styled$Lazy$lazy, $author$project$Select$viewSelectInput, $author$project$Select$ViewSelectInputData(selectId)(state_.inputValue)(enterSelectTargetItem)(state_.activeTargetIndex)(totalMenuItems)(state_.menuOpen)(config.variant)(config.labelledBy)(state_.jsOptimize)(state_.controlUiFocused)) : A2($rtfeldman$elm_css$Html$Styled$Lazy$lazy, $author$project$Select$viewDummyInput, A4($author$project$Select$ViewDummyInputData, $author$project$Select$getSelectId(selectId), enterSelectTargetItem, totalMenuItems, state_.menuOpen)) : $rtfeldman$elm_css$Html$Styled$text('');
                        var buildMulti = function() {
                            var _v2 = config.variant;
                            if (_v2.$ === 'Multi') {
                                var tagConfig = _v2.a.a;
                                var multiSelectedValues = _v2.b;
                                var resolveMultiValueStyles = 0 < $elm$core$List$length(multiSelectedValues) ? _List_fromArray([
                                    $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                                        $rtfeldman$elm_css$Css$marginRight($rtfeldman$elm_css$Css$rem(0.4375))
                                    ]))
                                ]) : _List_Nil;
                                return A2($rtfeldman$elm_css$Html$Styled$div, resolveMultiValueStyles, _Utils_ap(A2($elm$core$List$indexedMap, A3($author$project$Select$viewMultiValue, selectId, tagConfig, state_.initialMousedown), multiSelectedValues), _List_fromArray([
                                    buildInput
                                ])));
                            } else return buildInput;
                        }();
                        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(_List_fromArray([
                                $rtfeldman$elm_css$Css$displayFlex,
                                ...
                                $rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
                                $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
                                $rtfeldman$elm_css$Css$flex($rtfeldman$elm_css$Css$int(1)),
                                A2($rtfeldman$elm_css$Css$padding2, $rtfeldman$elm_css$Css$px(2), $rtfeldman$elm_css$Css$px(8)),
                                $rtfeldman$elm_css$Css$overflow($rtfeldman$elm_css$Css$hidden)
                            ]), withDisabledStyles))
                        ]), _List_fromArray([
                            buildMulti,
                    ...
                    function() {
                        var resolveLoadingSpinner = config.isLoading && config.searchable ? $author$project$Select$viewLoading : $rtfeldman$elm_css$Html$Styled$text('');
                        var clearButtonVisible = function() {
                            if (config.clearable && !config.disabled) {
                                var _v5 = config.variant;
                                if (_v5.$ === 'Single' && _v5.a.$ === 'Just') return true;
                                else return false;
                            } else return false;
                        }();
                        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                            ...
                            A2($matken11235$html_styled_extra$Html$Styled$Extra$viewIf, clearButtonVisible, A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                                $rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Select$indicatorContainerStyles)
                            ]), _List_fromArray([
                                A2($author$project$Select$clearIndicator, config, selectId)
                            ]))),
                            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                                $rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Select$indicatorContainerStyles)
                            ]), _List_fromArray([
                            ...
                            A2($rtfeldman$elm_css$Html$Styled$span, _List_fromArray([
                                $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                                    ...
                                    $rtfeldman$elm_css$Css$marginBottom($rtfeldman$elm_css$Css$px(8)),
                                    $rtfeldman$elm_css$Css$marginTop($rtfeldman$elm_css$Css$px(8)),
                                    $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(1)),
                                    $rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox)
                                ]))
                            ]), _List_Nil),
                            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                                ...
                                $author$project$Select$dropdownIndicator(config)
                            ]))
                        ]));
                    }(),
                    A2($matken11235$html_styled_extra$Html$Styled$Extra$viewIf, state_.menuOpen, A2($rtfeldman$elm_css$Html$Styled$Lazy$lazy, $author$project$Select$viewMenu, A7($author$project$Select$ViewMenuData, config.variant, selectId, viewableMenuItems, state_.initialMousedown, state_.activeTargetIndex, state_.menuNavigation, config.isLoading)))
                ]));
            }()
        ]));
    });
    var $author$project$Main$view = function(m) {
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                $rtfeldman$elm_css$Css$marginTop($rtfeldman$elm_css$Css$px(20)),
                $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$pct(50)),
                $rtfeldman$elm_css$Css$marginLeft($rtfeldman$elm_css$Css$auto),
                $rtfeldman$elm_css$Css$marginRight($rtfeldman$elm_css$Css$auto)
            ]))
        ]), _List_fromArray([
            A2($rtfeldman$elm_css$Html$Styled$map, $author$project$Main$SelectMsg, A2($author$project$Select$view, A2($author$project$Select$placeholder, 'Placeholder', A2($author$project$Select$menuItems, m.items, A2($author$project$Select$state, m.selectState, $author$project$Select$single(selectedItem)))), $author$project$Select$selectIdentifier('SingleSelectExample')))
        ]));
    };
                    ...
                    "unions": {
                        ...
                        "Select.Msg": {
                            ...
                            "tags": {
                                ...
                                "FocusMenuViewport": [
                                    "Select.SelectId",
                                    "Result.Result Browser.Dom.Error ( Select.MenuListElement, Select.MenuItemElement )"
                                ],
                                "MenuListScrollTop": [
                                    "Basics.Float"
                                ],
 ...
 */ if (module.hot) {
        ...
        */ function findNavKey(rootModel) {
            ...
            _Platform_initialize = function(flagDecoder, args, init, update, subscriptions, stepperBuilder) {
                ...
                var hookedInit = function(args1) {
                    var initialStateTuple = init(args1);
                    if (swappingInstance) {
            ...
            scope['_elm_hot_loader_init'] = function(Elm) {
                ...
                removedInstances.forEach(function(id1) {
                    delete instance[id1];
                });
...
},{}],"5xT53":[function(require,module,exports) {
(function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(require("@icelab/defo")) : "function" == typeof define && define.amd ? define([
        "@icelab/defo"
    ], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).defo);
})(this, function(e) {
    "use strict";
    function t(e1) {
    ...
    t(e).default({
        prefix: "es",
        views: {
            dynamicSelectInput: function(e1, t1) {
                var n, i, d, o, u, f, a = document.getElementById(t1.sizerId);
                return a && (n = e1, i = t1, t1 = (e1 = a).getBoundingClientRect().width, l = new MutationObserver((d = e1, o = n, u = t1, f = i, ()=>{
                    var e2 = d.getBoundingClientRect().width - u;
                    const t2 = e2 < f.defaultInputWidth ? f.defaultInputWidth : e2 + f.defaultInputWidth;
                    o.style.width = `${t2.toString()}px`;
                })), l.observe(a, r)), {
                    destroy: c,
                    update: c
                };
...
},{"@icelab/defo":"6opxL"}],"6opxL":[function(require,module,exports) {
(function(e, t) {
    ...
    "use strict";
    function e(e1, t) {
        return (function(e2, t1) {
            return Object.keys(e2.dataset).filter((e3)=>0 === e3.indexOf(t1)
            );
        })(e1, t).length > 0;
    }
    function t(e1) {
    ...
    function o({ prefix: e1 , scope: t1 , views: r1  }) {
        Object.keys(r1).forEach((o1)=>{
            const a = `data-${e1}-${(s = o1, s.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase())}`;
            var s;
            let i = Array.prototype.slice.call(t1.querySelectorAll(`[${a}]`));
            t1.hasAttribute(a) && (i = [
                t1
            ].concat(i)), i.forEach((t2)=>{
                n(t2, e1, r1, o1);
            });
        });
    }
    function n(e1, o1, n1, a) {
        if (e1._defoUpdate && e1._defoUpdate[a]) return;
        const s = n1[a], i = function(e2, r1) {
            var o2;
            return `${o2 = e2, o2.replace(/^[_.\- ]+/, "").toLowerCase().replace(/[_.\- ]+(\w|$)/g, (e3, t1)=>t1.toUpperCase()
            ).replace(/\d+(\w|$)/g, (e3)=>e3.toUpperCase()
            )}${t(r1)}`;
        }(o1, a);
        if (!s || !(i in e1.dataset)) return;
        const c = s(e1, r(e1.dataset[i]));
        e1._defoUpdate = e1._defoUpdate || {
        }, e1._defoDestroy = e1._defoDestroy || {
        }, e1._defoUpdate[a] = (function(e2) {
            return function(t1, o2) {
                t1 = t1 ? r(t1) : t1, o2 = o2 ? r(o2) : o2, Promise.resolve(e2).then((e3)=>{
                    e3.update && e3.update(t1, o2);
                });
            };
        })(c), e1._defoDestroy[a] = (function(e2, t1, r1) {
            return function() {
                Promise.resolve(e2).then((e3)=>{
                    e3.destroy && (e3.destroy(), delete t1._defoUpdate[r1], delete t1._defoDestroy[r1]);
                });
            };
        })(c, e1, a);
    }
    function a({ prefix: r1 , scope: a1 , views: s  }) {
        const i = new MutationObserver((a2)=>{
            a2.forEach((a3)=>{
                const i1 = a3.target;
                if ("attributes" === a3.type && (function(e1, t1) {
                    return 0 === e1.indexOf(`data-${t1}-`);
                })(a3.attributeName, r1)) {
                    const e1 = a3.attributeName.split("-").slice(2).map((e2, r2)=>r2 > 0 ? t(e2) : e2
                    ).join("");
                    i1.hasAttribute(a3.attributeName) ? null !== a3.oldValue ? i1._defoUpdate[e1](i1.getAttribute(a3.attributeName), a3.oldValue) : n(i1, r1, s, e1) : i1._defoDestroy[e1]();
                } else "childList" === a3.type && (Array.prototype.slice.call(a3.removedNodes).filter((e1)=>e1.nodeType === e1.ELEMENT_NODE
                ).filter((t1)=>e(t1, r1)
                ).forEach((e1)=>{
                    Object.keys(e1._defoDestroy).forEach((t1)=>{
                        e1._defoDestroy[t1]();
                    });
                }), Array.prototype.slice.call(a3.addedNodes).filter((e1)=>e1.nodeType === e1.ELEMENT_NODE
                ).forEach((e1)=>{
                    Promise.resolve(e1).then((e2)=>{
                        o({
                            prefix: r1,
                            scope: e2,
                            views: s
    ...
    return function({ prefix: e1 = "defo" , scope: t1 = document.documentElement , views: r1 = {
    }  } = {
    }) {
        const o1 = a({
            prefix: e1,
...
},{}]},["1xDW9","4eZwt"], "4eZwt", "parcelRequire2e7a")

//# sourceMappingURL=index.edd9ce35.js.map
